...
--Collect DB Info by AzizPW version 5.3
REM Collect DB Info by AzizPW version 5.3
ALTER SESSION SET NLS_DATE_FORMAT='DD-Mon-RR HH24:MI:SS';

--Document information
COL USER FOR A15
SELECT USER, 'OracleDB Info by AzizPW ver. 5.2' SCRIPT, SYSDATE COLLECT_DATE FROM DUAL;
...
COL SCHEMA FOR A25;
COL STATUS FOR A10;
SELECT COMP_ID,COMP_NAME,VERSION,VERSION_FULL,STATUS,MODIFIED,SCHEMA FROM DBA_REGISTRY ORDER BY 1;
...
--User's tablespace
SET LINES 250 PAGES 5000 TIMING ON;
