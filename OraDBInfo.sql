...
--Collect DB Info by AzizPW version 4.9
REM Collect DB Info by AzizPW version 4.9
ALTER SESSION SET NLS_DATE_FORMAT='DD-Mon-RR HH24:MI:SS';

--Document information
COL USER FOR A15
SELECT USER, 'OracleDB Info by AzizPW ver. 4.9' SCRIPT, SYSDATE COLLECT_DATE FROM DUAL;
...
FROM (SELECT COMMAND_ID, START_TIME, TIME_TAKEN_DISPLAY, STATUS, INPUT_TYPE, OUTPUT_DEVICE_TYPE, INPUT_BYTES_DISPLAY, OUTPUT_BYTES_DISPLAY, OUTPUT_BYTES_PER_SEC_DISPLAY FROM V$RMAN_BACKUP_JOB_DETAILS ORDER BY START_TIME DESC) R WHERE ROWNUM < 26;
...
SELECT INSTANCE_NAME||'_' INSTANCE_NAME FROM V$INSTANCE;
SPOOL OraDBInfoAzizPW_&&INSNAME&&TGL&&suffix
--Collect DB Info by AzizPW version 4.8
REM Collect DB Info by AzizPW version 4.8
ALTER SESSION SET NLS_DATE_FORMAT='DD-Mon-RR HH24:MI:SS';

--Document information
COL USER FOR A15
SELECT USER, 'OracleDB Info by AzizPW ver. 4.8' SCRIPT, SYSDATE COLLECT_DATE FROM DUAL;
