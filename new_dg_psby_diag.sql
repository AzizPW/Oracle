...
My Oracle Support For Employees Logo
		
PowerView is Off	
	
		
	Gavin (Not Available)	
	Profile			Last Refreshed: 06-Feb-2015 09:58 GMT(0)				
	Help	
...
Click to remove from Favorites		Script to Collect Data Guard Physical and Active Standby Diagnostic Information for Version 10g and above (Including RAC) (Doc ID 1577406.1)	To BottomTo Bottom	
Applies to:
