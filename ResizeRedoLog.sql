...
--RAC
ALTER DATABASE ADD LOGFILE THREAD 1 GROUP 11 ('+REDO') SIZE 50M;
ALTER DATABASE ADD LOGFILE THREAD 2 GROUP 12 ('+REDO') SIZE 50M;
ALTER DATABASE ADD LOGFILE THREAD 1 GROUP 13 ('+REDO') SIZE 50M;
ALTER DATABASE ADD LOGFILE THREAD 2 GROUP 14 ('+REDO') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 15 ('+REDO') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 2 GROUP 16 ('+REDO') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 17 ('+REDO') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 2 GROUP 18 ('+REDO') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 19 ('+REDO') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 2 GROUP 20 ('+REDO') SIZE 50M;